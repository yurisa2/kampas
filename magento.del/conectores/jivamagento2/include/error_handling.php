...
class error_handling extends event_base
{
  ...
  */
  ...
  {
    $this->mensagem = array('Nome do Evento' => $this->nome_funcao ,
    'Mensagem do Evento' => $this->saida ,
    'Titulo do Evento' => $this->titulo ,
    'Tipo do Evento' => $this->tipo,
    'Time do Evento' => $this->time);
  }
  ...
  */
  ...
  {
    $this->mensagem = json_encode(array('Nome do Evento' => $this->nome_funcao ,
    'Mensagem do Evento' => $this->saida ,
    'Titulo do Evento' => $this->titulo ,
    'Tipo do Evento' => $this->tipo,
    'Time do Evento' => $this->time));
